...
$r_instances_persistant_instance_timeout = 900; //after set period of instance inactivity in seconds the instance will be closed
$r_instances_persistant_server_timeout = 1080; //after set period of server inactivity in seconds the server will be closed ( new instances can restart it anytime )
$r_max_execution_time = 180; //maximum R execution time ( prevents infinite loops in R on server )
