...
<table>
    <tr>
        <td><span class="spanIcon tooltip ui-icon ui-icon-plus" onclick="Test.uiAddLogicSection($('#divSectionSubContent_<?= $_POST['counter'] ?>'),true,<?= $_POST['counter'] ?>,null,true)"  title="<?= Language::string(232) ?>"></span>
        </td>
    </tr>
</table>