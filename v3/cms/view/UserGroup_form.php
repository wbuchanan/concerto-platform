    ...
    <div class="padding ui-widget-content ui-corner-all margin">
        <table>
            ...
            <tr>
                ...
                <td><span class="tooltip spanIcon ui-icon ui-icon-help" title="<?= Language::string(155) ?>"></span></td>
                <td class="fullWidth">
                    <div class="horizontalMargin">
            ...
            { ?>
                <tr>
                    ...
                    <td><span class="tooltip spanIcon ui-icon ui-icon-help" title="<?= Language::string(156) ?>"></span></td>
                    <td class="fullWidth">
                        <div class="horizontalMargin">
