...
class Hottext extends AChoice {
    ...
    public function get_HTML_code() {
        ...
        return sprintf("<input type='checkbox' name='%s' value='%s' class='QTIhottext' onclick='QTI.maxChoices(%s,\"%s\",this,%s)' /><font class='QTIhottextLabel'>%s</font>", $this->parent->responseIdentifier, $this->identifier, $this->TestSection_id, $this->parent->responseIdentifier, $this->parent->maxChoices, $this->get_contents());
    }
