...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../cms/css/jQueryUI/cupertino/jquery-ui-1.9.2.custom.min.css" />

        <script type="text/javascript" src="../cms/js/lib/jquery-1.8.3.min.js"></script>
        <script type="text/javascript" src="../cms/js/lib/jquery-ui-1.9.2.custom.min.js"></script>
