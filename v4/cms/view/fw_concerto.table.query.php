...
<!-- select columns -->
<fieldset class="padding ui-widget-content ui-corner-all margin <?= $type != "SELECT" ? "notVisible" : "" ?>">
    <legend>
        <table>
            <tr>
...
<!-- set -->
<fieldset class="padding ui-widget-content ui-corner-all margin <?= $type != "INSERT" && $type != "REPLACE" && $type != "UPDATE" ? "notVisible" : "" ?>">
    <legend>
        <table>
            <tr>
...
<!-- group by -->
<fieldset class="padding ui-widget-content ui-corner-all margin <?= User::view_class() ?> <?= $type != "SELECT" ? "notVisible" : "" ?>">
    <legend>
        <table>
            <tr>
